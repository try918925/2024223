...
from .rec_postprocess import CTCLabelDecode, AttnLabelDecode, SRNLabelDecode, my_CTCLabelDecode,\
...
def build_post_process(config, global_config=None):
    support_dict = [
        'DBPostProcess', 'EASTPostProcess', 'SASTPostProcess', 'my_CTCLabelDecode',
