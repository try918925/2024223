...
import copy
from new_util import crop_images
...
#                     frame_cpu_orgin = frame.download()
...
class ImageCaptureProcess(Process):
    def __init__(self, camera_info, queue):
        ...
        self.roi_rows = (self.roi[0], self.roi[1])
        self.counter = 0
        self.frame_interval = 1 / 25.0  # 控制帧率为25帧
        self.last_time = time.time()  # 初始化上一次帧处理时间
